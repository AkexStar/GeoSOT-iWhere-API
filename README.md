...
API的中文使用文档说明可在[这里](https://github.com/AkexStar/GeoSOT-iWhere-API/tree/main/openapi)获取，本项目同时使用[SwaggerUI](https://app.swaggerhub.com/apis/Akex/GeoSOT-iwhere-openapi/1.2.4#/)进行可视化，可在上面进行在线接口尝试。
